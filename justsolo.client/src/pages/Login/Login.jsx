...
async function confirmLogin(email, password) {
    try {
        const response = await fetch('eshop-production-2411.up.railway.app', { method: 'POST', headers: { 'Content-Type': 'application/json', 'Accept': 'application/json' }, body: JSON.stringify({ correo: email, clave: password }) });
